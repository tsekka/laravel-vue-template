...
<template>
  <div class="bg-white">
    <Popover as="header" class="relative">
      ...
      >
        <PopoverPanel focus class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top lg:hidden">
          <div class="rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
            <div class="px-5 pt-4 flex items-center justify-between">
              <div>
                <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=teal&shade=500" alt="todo" />
              </div>
              <div class="-mr-2">
                <PopoverButton
            ...
            <div class="pt-5 pb-6">
              ...
              <div class="mt-6 px-5">
                <a
                  href="#"
                  class="block text-center w-full py-2 px-4 border border-transparent rounded-md shadow bg-teal-500 text-white font-medium hover:bg-teal-600"
                >Login</a>
              </div>
            </div>
          </div>
    ...
    <main class="overflow-hidden">
      ...
      <div class="bg-warm-gray-50">
        <div class="py-24 lg:py-32">
          <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
            ...
            <p
              class="mt-6 text-xl text-warm-gray-500 max-w-3xl"
            >Vel nunc non ut montes, viverra tempor. Proin lectus nibh phasellus morbi non morbi. In elementum urna ut volutpat. Sagittis et vel et fermentum amet consequat.</p>
          </div>
        </div>
      </div>
          ...
          <div class="relative bg-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
              ...
              <div class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-teal-500 to-teal-600 sm:px-10 xl:p-12">
                ...
                <p
                  class="mt-6 text-base text-teal-50 max-w-3xl"
      ...
      <section aria-labelledby="offices-heading">
        <div class="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          >Varius facilisi mauris sed sit. Non sed et duis dui leo, vulputate id malesuada non. Cras aliquet purus dui laoreet diam sed lacus, fames.</p>
      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          <div class="space-y-8 xl:col-span-1">
            ...
            <p class="text-warm-gray-400 text-base">Making the world a better place through constructing elegant hierarchies.</p>
            <div class="flex space-x-6">
              <a
                v-for="item in footerNavigation.social"
                :key="item.name"
                :href="item.href"
                class="text-warm-gray-400 hover:text-warm-gray-300"
              >
          ...
          <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-sm font-semibold text-warm-gray-200 tracking-wider uppercase">Solutions</h3>
              ...
              <div class="mt-12 md:mt-0">
                <h3 class="text-sm font-semibold text-warm-gray-200 tracking-wider uppercase">Support</h3>
                <ul role="list" class="mt-4 space-y-4">
            ...
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-sm font-semibold text-warm-gray-200 tracking-wider uppercase">Company</h3>
                <ul role="list" class="mt-4 space-y-4">
              ...
              <div class="mt-12 md:mt-0">
                <h3 class="text-sm font-semibold text-warm-gray-200 tracking-wider uppercase">Legal</h3>
                <ul role="list" class="mt-4 space-y-4">
